...
- **Civic data overlays**: 311 complaints, active DOT road projects, bike lane coverage, MTA bus routes at each intersection.
...
- **Coverage gap explainer**: Camera density mapped across neighborhoods — where public infrastructure is dense vs sparse. A civic literacy tool, not a surveillance one.
